    ...
    <div id="astro-wrap" class="g-main">
        ...
        <div class="baseinfo">
            ...
            <div class="timeinfo">
                <ul>
                    <li>
                        <i class="icon i-view"></i>审核：<%=task.getTask().getTaskCycle() %>
                    </li>
                    <li>
        ...
        <div class="task">
            ...
            <ul class="flow">
                ...
                <% for (int i = 0; i < task.getTaskSetps().size(); i++) { if(task.getTaskSetps().get(i).getSetpType().equals(1)){%>
                <li>
                    <span class="num"><%=task.getTaskSetps().get(i).getSortNo() %></span><%=task.getTaskSetps().get(i).getContent() %>></li>
                <li>
                <%}} %>
            </ul>
            <ul class="tips">
            <% for (int i = 0; i < task.getTaskSetps().size(); i++) { if(task.getTaskSetps().get(i).getSetpType().equals(2)){%>
                <li><%=task.getTaskSetps().get(i).getContent() %></li>
            <%}} %>
            </ul>
        </div>
        <div class="labinfo">
        ...
        <div class="labinfo">
            任务参与人数<%=task.getTask().getPartnerNum() %>
