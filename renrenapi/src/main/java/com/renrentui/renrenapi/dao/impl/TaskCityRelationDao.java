...
@Repository
public class TaskCityRelationDao extends DaoBase implements ITaskCityRelationDao{
	...
	public int insertList(List<TaskCityRelation> recordList) {
		return getMasterSqlSessionUtil().insert("com.renrentui.renrenapi.dao.inter.ITaskCityRelationDao.insertList",recordList);
	}
