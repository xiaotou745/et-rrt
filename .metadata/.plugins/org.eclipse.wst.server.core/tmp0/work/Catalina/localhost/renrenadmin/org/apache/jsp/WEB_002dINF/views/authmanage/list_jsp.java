...
List<RoleInfo> roleData = (List<RoleInfo>) request.getAttribute("roleData");
      ...
      out.write("\t\t\t\t<input type=\"text\" placeholder=\"请输入账号名称\"\r\n");
      out.write("\t\t\t\t\tclass=\"input-sm form-control\" id=\"txtKeyword\"\r\n");
      out.write("\t\t\t\t\tstyle=\"width: 250px; height: 34px;\" value=\"\" />\r\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"btn btn-w-m btn-primary\" id=\"btnSearch\"\r\n");
      out.write("\t\t\t\t\tstyle=\"margin-left: 3px;\">查询</button>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("var jss={search:function(currentPage){\r\n");
      out.write("\t\t\tvar keywordvalue=$(\"#txtKeyword\").val();\r\n");
      out.write("\t\t\tvar data={Keyword:keywordvalue,currentPage:currentPage};\r\n");
      out.write("\t\t\t$.post(\"");
      out.print(basePath);
      out.write("/authmanage/listdo\", data, function(d) {\r\n");
