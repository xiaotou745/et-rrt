 ...
 * 2015-10-15T15:23:57.781+08:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "Sms", 
                  wsdlLocation = "http://123.57.234.98:8911/sms.asmx?wsdl",
...
public class Sms extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://123.57.234.98:8911/sms.asmx?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Sms.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://123.57.234.98:8911/sms.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
